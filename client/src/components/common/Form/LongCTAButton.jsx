...
export default function LongCTAButton({
  ...
  return loading ? (
    <button
      disabled
      type="button"
      className="bg-richblack-800 focus:ring-richblack-300 text-richblack-5 me-2 flex w-full flex-row items-center justify-center rounded-lg p-3 font-medium shadow-md active:scale-[98%]"
    >
      <svg
        aria-hidden="true"
        role="status"
        className="text-richblack-5 me-3 inline h-4 w-4 animate-spin"
        viewBox="0 0 100 101"
        fill="none"
