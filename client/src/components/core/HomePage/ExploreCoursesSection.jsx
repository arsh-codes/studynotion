    ...
    <section className="relative mx-auto w-11/12 px-4 py-8 select-none md:px-28">
      ...
      <div className="absolute -top-0 right-1 left-1 flex flex-col items-center gap-8 md:gap-20">
            ...
            >
              <div
                className={`text-xl leading-7 font-semibold ${
                  selectedCourse === course ? "text-richblack-800" : "text-richblack-25"
                }`}
              >
                {course.heading}
              </div>
              <div
                className={`pb-3 leading-normal font-normal ${
                  selectedCourse === course ? "text-richblack-500" : "text-richblack-400"
                }`}
              >
                {course.description}
              </div>
              ...
              {/* Footer Section */}
              <section
                className={`absolute right-0 bottom-0 left-0 flex justify-between border-t ${
                  selectedCourse === course
        ...
        <div className="flex gap-6">
          <CtaButton text="Explore Full Catalog" primaryButton />
