...
const SwissKnifeSection = () => {
  return (
    <section className="mx-auto flex w-11/12 flex-col items-center gap-12 py-20">
      <div className="flex flex-col items-center gap-3">
        <h3 className="text-4xl font-semibold leading-[44px] text-[#000814]">
          Your swiss knife for
          <HighlightText text="learning any language" />
        </h3>
        <p className="text-balance text-center text-base font-medium text-richblack-700">
      ...
      <div className="flex items-center justify-center bg-pure-greys-5">
        <img
          src={knowYourProgressImage}
          alt="Progress tracking"
          className="z-0 -mr-36 -translate-y-6"
        />
        <img
